	...
	},
	{
		...
		prompts: [
			...
			},
			{
				...
				shortPrompt: {
					en: "Could come to life",
					es: "Podría cobrar vida",
				},
			},
			{
			...
			},
			{
				...
				shortPrompt: {
					en: "Pet-worthy animal",
					es: "Animal para mascota",
				},
			},
			{
	...
	},
	{
		...
		prompts: [
			...
			},
			{
				...
				shortPrompt: {
					en: "Illusory graffiti",
					es: "Graffiti ilusorio",
				},
			},
			{
